...
public class Room {
    /*
    METHOD FOR OVERLAPPING ROOMS
     01 Keep a list of all existing rooms during world generation.
     02 Write an overlap method for Room class.
     03 Reject any generated room that overlaps an existing one.
     */
    int width;
    int height;
    Position position;
